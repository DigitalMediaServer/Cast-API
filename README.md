...
[![Maven Central](https://maven-badges.sml.io/sonatype-central/org.digitalmediaserver/cast-api/badge.svg)](https://maven-badges.sml.io/sonatype-central/org.digitalmediaserver/cast-api) ![NO AI](https://raw.githubusercontent.com/nuxy/no-ai-badge/master/badge.svg) [![AI-DECLARATION: none](https://img.shields.io/badge/䷼%20AI--DECLARATION-none-dcfce7?labelColor=dcfce7)](https://ai-declaration.md)
...
This repository is 100% human-authored and intends to stay that way.

- We do **not** accept Pull Requests containing code generated by LLMs.
- All contributions must be written by a human. Submissions suspected of being LLM slop will be closed immediately.
